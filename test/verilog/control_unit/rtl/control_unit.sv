            ...
            MODE_MAP: begin
                case (opcode)
                    ...
                    default: begin
                        ...
                        // datapath.sv -- see CLAUDE.md for why this alone doesn't make this file
                        // yosys-clean (line ~49's $readmemh has its own, separate synthesizability issue).
`ifdef VERILATOR
